...
// Which user has the shortest email address and what is that address?
function findTheShortestEmailAddress(dataset) {
  let length = dataset[0].email.length;
  let email;
...
const shortestEmailAddress = findTheShortestEmailAddress(dataset);
console.log(shortestEmailAddress);
